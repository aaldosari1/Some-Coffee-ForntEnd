...
function UserProfile() {
  ...
  useEffect(() => {
    axios
      .get(`https://some-coffee-backend.herokuapp.com/user/${state.user.id}`)
      .then((res) => {
        setUser(res.data);
  ...
  const update = () => {
    ...
    axios
      .put(
        `https://some-coffee-backend.herokuapp.com/user/${state.user.id}`,
        data
      )
      .then((res) => {
        console.log(res.data);
  ...
  const deleteFunction = (e) => {
    ...
    axios
      .delete(
        `https://some-coffee-backend.herokuapp.com/reservation/${e.target.value}`
      )
      .then((res) => {
        axios
          .get(`https://some-coffee-backend.herokuapp.com/reservation`)
          .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`https://some-coffee-backend.herokuapp.com/review`)
      .then((res) => {
        setReviews(res.data);
